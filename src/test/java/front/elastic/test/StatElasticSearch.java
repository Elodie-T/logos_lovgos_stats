...
public class StatElasticSearch {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
		...
		List<SessionLibelle> sl = cu.getSessions().getSessionLibelle();
...
//		sd.addUserSessionById(2, "logos", geoLoc);
//		sd.deconnectionUserById(4840);
//		List<User> liste = usersService.getAllUsers();
//		
//		List<User> liste1 = new ArrayList<User>();
//		liste1.add(usersService.getUserByID(4840));
